...
#%%
path_df = r"F:\CROP-PIER\CROP-WORK\InfuseData 20210721.csv"
root_raster = r"C:\Users\PongporC\Desktop\temp\S1AB"
root_save = r"F:\CROP-PIER\CROP-WORK\Sentinel1_dataframe_updated\s1ab_temporal_malison_2020_new"
#%%
df = pd.read_csv(path_df)
df = df[df["warranty_plantdate"].str.slice(-4,) == "2020"]
gdf = gpd.GeoDataFrame(df)
gdf["geometry"] = gdf["wkt_polygon"].apply(lambda val: loads(val))
    ...
    if file_raster.endswith(".vrt"):
        ...
        for _, row in gdf.iterrows():
            try:
                ...
                plant_date = datetime.datetime.strptime(row["warranty_plantdate"], "%d/%m/%Y")
