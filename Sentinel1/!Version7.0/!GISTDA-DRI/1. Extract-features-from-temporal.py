...
def extract_intensity_features(df_temporal, columns):
    ...
    return df 
#%%
root_save = r"F:\CROP-PIER\CROP-WORK\Sentinel1_dataframe_updated\gistda_dri_features"
...
for p in list_p:
    ...
    for year, df_temporal_grp in df_temporal.groupby("final_plant_year"):
        ...
        path_save = os.path.join(root_save, f"gistda_dri_features_{p}_{year}.parquet")
