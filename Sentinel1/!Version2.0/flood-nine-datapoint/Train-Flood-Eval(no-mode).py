...
root_df_dry = r"F:\CROP-PIER\CROP-WORK\Sentinel1-dataframe-updated\s1_noflood_pixel_from_mapping_v3_nine_datapoint"
root_df_flood = r"F:\CROP-PIER\CROP-WORK\Sentinel1-dataframe-updated\s1_flood_pixel_from_mapping_v3_nine_datapoint"
...
#    model_name = 'all'
    ...
    thresholds = np.insert(np.linspace(all_predicted_pixels[all_predicted_pixels!=-9999].min(), all_predicted_pixels.max(), 200)[::-1], 0, all_predicted_pixels.max()+1)
