...
def get_df_flood_nonflood(root_df_flood, root_df_nonflood, p, strip_id):
    ...
    # Interpolate nan
    df_flood.loc[df_flood[columns_pixel_values].isna().any(axis=1), columns_pixel_values] = interp_numba(df_flood.loc[df_flood[columns_pixel_values].isna().any(axis=1), columns_pixel_values].values)
    df_nonflood.loc[df_nonflood[columns_pixel_values].isna().any(axis=1), columns_pixel_values] = interp_numba(df_nonflood.loc[df_nonflood[columns_pixel_values].isna().any(axis=1), columns_pixel_values].values)
